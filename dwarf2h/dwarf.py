...
## Graphviz rendering moved to dwarf2h/render_graphviz.py
...
def render_reverse_dependencies(
    ...
    from . import render_c

    return render_c.render_reverse_dependencies(cu_prefix, root_die, status_cb)
...
def render_all_definitions(
    ...
    *,
    ...
    return render_c.render_all_definitions(
        dwarf_infos,
        status_cb,
        include_dependency_tree=include_dependency_tree,
    )
...
def render_reverse_dependencies_graphviz(
    ...
    from . import render_graphviz

    return render_graphviz.render_reverse_dependencies_graphviz(cu_prefix, root_die, status_cb)
...
def render_all_definitions_graphviz(
    ...
    return render_graphviz.render_all_definitions_graphviz(dwarf_infos, status_cb)
